/**
 * Scan Unique Non-Alphanumeric Characters (Full Translations)
 *
 * Reads every .txt file in `translated-full/`, decoding from Shift-JIS or
 * UTF-8 as detected, and prints all unique characters that are not ASCII
 * alphanumeric (a-z, A-Z, 0-9).
 *
 * Usage:
 *   node scan-characters-full.mjs
 */
